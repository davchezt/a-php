...
function getToken($payload = ['user_id' => '1'])
{
	$headers = ['alg' => 'HS256', 'typ' => 'JWT'];
	$header_encode = base64url_encode(json_encode($headers));

	$payload_encode = base64url_encode(json_encode($payload));

	$secret_code = 'DaVchezt';
	
	$signature = hash_hmac('SHA256', $header_encode . '.' . $payload_encode, $secret_code, true);
